...
public:
    virtual void execute(command_tokenizer::iterator tok1,command_tokenizer::iterator tok2)
    {
        ...
        file_system_by_name::iterator it=fs.find(boost::make_tuple(current_dir,dir));
        if(it==fs.end())
        {
...
public:
    virtual void execute(command_tokenizer::iterator tok1,command_tokenizer::iterator tok2)
    {
        ...
        if(!option.empty())
        {
            ...
            boost::tie(it0,it1)=fs_by_size.equal_range(boost::make_tuple(current_dir));
